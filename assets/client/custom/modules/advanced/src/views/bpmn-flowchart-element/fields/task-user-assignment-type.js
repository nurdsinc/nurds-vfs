...
['views/fields/enum', 'advanced:views/bpmn-flowchart-element/fields/task-send-message-from'],
function (Dep, From) {
    ...
    return Dep.extend({
        ...
        setupOptions: function () {
            ...
            const linkOptionList = From.prototype.getLinkOptionList.call(this, true, true);
