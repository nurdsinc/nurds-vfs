...
define('sales:views/inventory-number/record/panels/warehouses-quantity',
['sales:views/product/record/panels/warehouses-quantity'], function (Dep) {

    return class extends Dep {

        // noinspection JSUnusedGlobalSymbols
        setupRecordParams() {
            this.url = `InventoryNumber/${this.model.id}/warehousesQuantity`;
